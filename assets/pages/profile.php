...
<div class=" container mt-5 p-2"></div>
...
<div class="container col-md-9 col-sm-11 rounded-0">
   ...
   <!--  <link rel="stylesheet" href="./assets/js/mas/bootstrap.min.css"> -->
    <script src="./assets/js/mas/jquery.min.js">
    </script>
    <script src="./assets/js/mas/popper.min.js">
    </script>
    <script src="./assets/js/mas/bootstrap.min.js">
    </script>

    <link rel="stylesheet" href="./assets/js/mas/style.css">
                    ...
                    <div class="col-md-12">
                        <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Multimedia</a>
                               <!-- <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Project Tab 3</a> -->
                            </div>
                        </nav>
                       
                        <div class=" p-4 tab-content" id="nav-tabContent">
                            ...
                            <table class="table" cellspacing="0">
                                    ...
                                    -->
                                    <h2> Aqui van las publicaciones</h2>
                            </div>
