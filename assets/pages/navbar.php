<?php global $user; ?>
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white border">
    <div class="container col-lg-9 col-sm-12 col-md-10 d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
        <div class="d-flex justify-content-between col-lg-8 col-sm-12">
            ...
            <form class="d-flex" id="searchform">
                <input class="form-control me-2" type="search" id="search" placeholder="busca a alguien.." aria-label="Search" autocomplete="off">
                <div class="bg-white text-end rounded border shadow py-3 px-4 mt-5" style="display:none;position:absolute;z-index:+99;" id="search_result" data-bs-auto-close="true">
                    ...
                    <div id="sra" class="text-start">
                        <p class="text-center text-muted">ingresa su nombre</p>
        ...
        <ul class="navbar-nav flex-fill flex-row justify-content-evenly mb-lg-1 mb-sm-0">
            ...
            <li class="nav-item dropdown dropstart">
                ...
                <a class="nav-link" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"> <i class="bi bi-bar-chart-fill"></i></a>

                <ul class="dropdown-menu position-absolute top-100 end-50" aria-labelledby="navbarDropdown">

                    <li><a class="dropdown-item" href="?lechistory"><i class="bi bi-bar-chart-steps"></i> Historial de lecturas</a></li>
                    <li><a class="dropdown-item" href="?lecrealtime"><i class="bi bi-broadcast-pin"></i> Tiempo real</a></li>
            ...
            <!-- <a class="nav-link text-dark" href="?"><i class="bi bi-bar-chart-fill"></i></a> -->
            ...
            <li class="nav-item dropdown dropstart">
                ...
                <ul class="dropdown-menu position-absolute top-100 end-50" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="?editprofile"><i class="bi bi-pencil-square"></i> Editar datos de perfil</a></li>
                    <!--<li><a class="dropdown-item" href="#"><i class="bi bi-gear"></i> Account Settings</a></li> -->
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><a class="dropdown-item" href="assets/php/actions.php?logout"><i class="bi bi-box-arrow-in-left"></i> Cerrar sesion</a></li>
                </ul>
            </li>
